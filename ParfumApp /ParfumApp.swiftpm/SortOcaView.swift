import SwiftUI
struct OccasionAndSeason {
    static var selectedOccasion = ""
    static var selectedSeason = ""
    static var selectedPerfume = "" 
}
struct SortOcaView: View {
...
struct SortOcaView_Previews: PreviewProvider {
